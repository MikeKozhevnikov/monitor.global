...
$root = str_replace("\include\ofc\Charts\Area", "", dirname ( __FILE__ ));
$root = str_replace("/include/ofc/Charts/Area", "", $root);
define ( 'ROOT_DIR', $root );
unset($root);

require_once(ROOT_DIR . '/include/ofc/OFC/Charts/OFC_Charts_Area.php');
