...
$root = str_replace("\include\ofc\Elements\Axis", "", dirname ( __FILE__ ));
$root = str_replace("/include/ofc/Elements/Axis", "", $root);
define ( 'ROOT_DIR', $root );
unset($root);

require_once(ROOT_DIR . '/include/ofc/OFC/Elements/OFC_Elements_Axis.php');
