...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    //    $out[] = '<script type="text/javascript" src="'. $base .'template/js/swfobject.js"></script>';
    }
    else
    {
    ...
    $out[] = '<param name="movie" value="'. $base .'template/swf/open-flash-chart.swf" />';
    $out[] = '<param name="FlashVars" value="data-file='. $url .'"/>';
    $out[] = '<param name="quality" value="high" />';
    $out[] = '<param name="bgcolor" value="#FFFFFF" />';
    $out[] = '<embed src="'. $base .'template/swf/open-flash-chart.swf" FlashVars="data-file='. $url .'" quality="high" bgcolor="#FFFFFF"
