...
lang : {
	...
	focusTitle : 'Кликните, чтобы переместить на передний план',
	fullExpandTitle : 'Изменить размер до актуального (клавиша f)',
	creditsText : 'Monitor Global',
	creditsTitle : 'Перейти на Monitor Global',
	...
	restoreTitle : 'Кликните, чтобы закрыть картинку, кликните и удерживайте для перемещения.'
},
...
creditsHref : 'http://monitor.webcodes.club/',
creditsTarget : '_self',
